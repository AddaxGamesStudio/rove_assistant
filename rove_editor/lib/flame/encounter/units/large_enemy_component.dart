...
import 'package:rove_editor/flame/encounter/units/defense_component.dart';
import 'package:rove_editor/flame/encounter/units/health_component.dart';
import 'package:rove_editor/flame/encounter/units/large_tile_component.dart';
...
class LargeEnemyComponent extends CoordinateComponent with UnitComponent {
  ...
  void update(double dt) {
    ...
    if (focused) {
      ...
      final hasEffectBelow =
          model.coordinates.any((c) => game.model.hasEffectAtCoordinate(c));
