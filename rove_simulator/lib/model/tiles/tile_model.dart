...
mixin Slayable on TileModel {
  ...
  int get defense {
    final etherDefense =
        nearbyEther.fold(0, (value, ether) => value + ether.ether.defenseBuff);
    final glyphDefense =
        affectingGlyphs.fold(0, (value, glyph) => value + glyph.defenseBuff);
    return etherDefense + glyphDefense;
  }

  List<EtherNodeModel> get nearbyEther;
  ...
  setSaveablePropertiesBeforeChildren(Map<String, dynamic> properties) {
    ...
    health = properties['health'] as int? ?? 0;
    maxHealth = properties['max_health'] as int? ?? 0;
  }
...
abstract class TileModel extends ChangeNotifier with Saveable {
  ...
  setSaveablePropertiesBeforeChildren(Map<String, dynamic> properties) {
    ...
    if (coordinateString != null) {
      coordinate = EvenQHexCoordinate.fromString(coordinateString);
    } else {
  ...
  @override
  Map<String, dynamic> saveableProperties() {
    return {'coordinate': coordinate.toEvenQ().toString()};
  }
}
