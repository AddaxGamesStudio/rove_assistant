  ...
  return EncounterState(
    ...
    ..actionsWithKeyTriggerred =
        (json['actions_with_key_triggered'] as Map<String, dynamic>?)?.map(
            ...
            {}
    ..codexEntries = (json['codex_entries'] as Map<String, dynamic>?)?.map(
    ...
    .._exhaustedItems = (json['exhausted_items'] as Map<String, dynamic>?)?.map(
          (k, e) => MapEntry(
...
Map<String, dynamic> _$EncounterStateToJson(EncounterState instance) =>
    <String, dynamic>{
      ...
      'codex_entries':
          instance.codexEntries.map((k, e) => MapEntry(k.toString(), e)),
      'players_state':
      ...
      'exhausted_items': instance._exhaustedItems,
