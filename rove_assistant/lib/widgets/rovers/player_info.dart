...
class PlayerInfo extends StatelessWidget {
  ...
  _showDeactivateDialog(BuildContext context) {
    Analytics.logScreen('/player_detail/deactivate_dialog');
    showDialog(
        context: context,
...
//            iconAsset: player.roverClass.,
  ...
  _showMaximumPlayersDialog(BuildContext context) {
    Analytics.logScreen('/player_detail/cant_activate_dialog');
    showDialog(
        context: context,
        builder: (BuildContext context) => RoveConfirmDialog(
  ...
  _showMinimumPlayersDialog(BuildContext context) {
    Analytics.logScreen('/player_detail/cant_deactivate_dialog');
    showDialog(
        context: context,
        builder: (BuildContext context) => RoveConfirmDialog(
