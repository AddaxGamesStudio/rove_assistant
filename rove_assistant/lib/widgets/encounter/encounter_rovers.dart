...
import 'package:rove_assistant/widgets/encounter/encounter_ally_detail.dart';
...
import 'package:rove_assistant/widgets/encounter/encounter_figure_dialog.dart';
                ...
                children: [
                  EncounterSidePadding(
                      child: Text('Rover Faction',
                          style:
                              RoveTheme.titleStyle(color: RovePalette.body))),
                  EncounterSidePadding(
                  ...
                  SingleChildScrollView(
                    ...
                    padding: EdgeInsets.only(
                        left: max(viewPadding.left,
                            EncounterSidePadding.padding.left),
                        right: max(viewPadding.right,
                            EncounterSidePadding.padding.right)),
                    child: Row(
                      spacing: RoveTheme.horizontalSpacing,
                      children: listItems()
                          .map((item) => ListenableBuilder(
