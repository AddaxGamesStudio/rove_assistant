...
class EncounterPrefsDialog extends StatelessWidget {
  ...
  resetSettings(BuildContext context) {
    for (final entry in AssistantPreferences.defaults.entries) {
      Preferences.instance.setString(entry.key, entry.value);
    }
  }
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    CheckboxSetting(
                        ...
                        preference: AssistantPreferences.skipNarrativePref),
                    CheckboxSetting(
                        title: 'Skip Rules',
                        preference: AssistantPreferences.skipRulesPref),
                    SizedBox(
...
class CheckboxSetting extends StatelessWidget {
  ...
  void setValue(BuildContext context, bool value) async {
    Preferences.instance.setString(preference, value.toString());
  }

  @override
  Widget build(BuildContext context) {
    final value =
        bool.tryParse(Preferences.instance.getString(preference) ?? 'false') ??
            false;
