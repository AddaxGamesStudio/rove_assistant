...
import 'package:rove_assistant/ui/widgets/encounter/encounter_adversary_detail.dart';
import 'package:rove_assistant/ui/widgets/encounter/encounter_loot_dialog.dart';
import 'package:rove_assistant/ui/widgets/encounter/events/encounter_figure_page.dart';
...
class _FigureListItem extends _ListItem {
  ...
  void showImperviousDialog(BuildContext context) {
    showDialog(
        context: context,
        builder: (_) => RoveDialog(
            title: figure.nameToDisplay,
            body: EncounterFigurePageBody(
                message: '${figure.nameToDisplay} is impervious to damage.',
                figures: [figure],
                onContinue: () {
                ...
                actionWidget: model.showXulcDie
                    ? TextButton(
                        ...
                        child: Text(
                          'Roll Xulc Die',
                          style:
                              RoveStyles.subtitleStyle(color: RovePalette.xulc),
                        ))
                    : null,
              ),
              if (allItems.$2.isNotEmpty && !placeFactionBeforeAdversaries)
  ...
  Widget build(BuildContext context) {
    ...
    return Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
      Padding(
          ...
          child: Row(
            children: [
              Text(title, style: RoveStyles.titleStyle(color: Colors.black)),
              Spacer(),
