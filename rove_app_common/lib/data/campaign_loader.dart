...
class CampaignLoader {
  ...
  static Future<Codex> loadCodex(BuildContext context, int number,
    ...
    final path = '${_contentPacksPaths[expansion0]}codices/$number.txt';
  ...
  static Future<EncounterDef?> loadEncounter(
    ...
    switch (encounterId) {
      ...
      case 'I.1':
        return Intermissions.encounterIdot1;
      case '3.1':
      ...
      case 'I.2':
        return Intermissions.encounterIdot2;
      case '5.1':
      ...
      case 'I.3':
        return Intermissions.encounterIdot3;
      case '7.1':
      ...
      case 'I.4':
        return Intermissions.encounterIdot4;
      case '9.1a':
