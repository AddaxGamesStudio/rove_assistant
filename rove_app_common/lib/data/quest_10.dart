...
extension Quest10 on EncounterDef {
  static EncounterDef get encounter10dot1 => EncounterDef(
        ...
        challenges: [
          ...
          'When rolling the xulc dice, reroll any results of [critical].',
        ...
        onMilestone: {
          CampaignMilestone.milestone10dot1XulcRevealed: [
            codex('Kill it With Fire!', page: 1),
...
Writhing stomaw and stolen urn have the infected [infected] trait.

Spawn one cleaving xulc in the space of the urn or stomaw that was just slain.'''),
            rules('Infected',
                '''Make sure you have the Xulc card [image] – flipped to the Side A – xulc standees, and xulc dice nearby.
...
For the remainder of this campaign, keep the xulc page, xulc standees, and xulc dice nearby. All enemies with the [infected] trait follow these rules. Until instructed otherwise, always use the [A] side of the xulc page.
...
Open the infected deck of skill cards. All Rovers must select and permanently add one infected skill card to their hand. This infected card does not count toward the number of skill or reaction cards you may take into an encounter.'''),
        ...
        adversaries: [
          ...
          EncounterFigureDef(
            ...
            flies: true,
            traits: [
              '[Reaction] After this unit is attacked: ||| Logic: Retreat ||| [Dash] 2',
            ],
            affinities: {
              Ether.dim: 1,
            },
          ...
          EncounterFigureDef(
            ...
            flies: true,
            traits: [
              '[React] Before this unit is slain it performs: ||| [m_attack] | [Range] 1-2 [DMG]2 | [Lingering Miasma] | [Target] all units',
            ],
            affinities: {
              Ether.crux: -2,
              Ether.morph: 2,
...
Encounter 4 - “**Ought Never to Sprout**”, [campaign] **24**.''',
        challenges: [
          ...
          'When an effect of the Nidus would have you roll the xulc dice, reroll any results of [critical].',
        ],
        allies: [
          AllyDef(
            name: 'Hra',
...
**Gargaki**: When a writhing stomaw is slain, perform: [Heal] | [Range] 0-1 [RCV] 1 | [Everbloom]''',
        ...
        onMilestone: {
          '_victory': [
            codex('It Burst with a Nervous Little Pop!', page: 4),
            victory(
                body:
...
All Rovers must select and permanently add one infected skill card to their hand. This infected card **DOES** count toward the number of skill or reaction cards you may take in an encounter.'''),
        ...
        adversaries: [
          ...
          EncounterFigureDef(
            ...
            traits: [
              '[Reaction] After this unit suffers [DMG] as part of an attack: Roll the Xulc dice and spawn the result within [Range] 1 of this unit.',
            ],
            onSlain: [
              milestone('_victory'),
            ],
        ...
        placements: [
          ...
          PlacementDef(
            ...
            fixedTokens: ['C'],
            onLoot: [
              codex('What Will Never Be', page: 3),
...
When an adversary **with the [Infected] trait** is slain, place it off to the side of the map on its side. During the **start phase**, for each adversary that is both off to the side and flipped vertically, roll an ether dice from the general pool, then spawn that adversary at the space with the ether icon corresponding to the result of the roll  Then, for each adversary that is both off to the side and placed on its side, flip them vertically.'''),
          ...
          codexLink('Riddled Shell',
              number: 2,
              body: 'Each time a stolen urn is slain, read [title] [codex] 2.'),
...
Mo and Makaal’s shop is open again. Their shop is in the same state as it was at the end of the core box campaign. Their shop consists of the merchant level 1 through 4 decks. Check your core box campaign sheet and add all reward weapons and armors marked to the shop.'''),
        ...
        overlays: [
          EncounterFigureDef(
            name: 'Hoard',
            onLoot: [
              codex('What Do We Have Here?', page: 6),
...
[Dash] 1 << Ignore all movement penalties. || [m_attack] | [Range] 1 [DMG]3 | [Push] 2 |
...
[Dash] 3 << Ignore all movement penalties. || [Heal] | [RCV] 1 | [everbloom] | [Target] self and all allies moved through''',
              condition: MilestoneCondition(CampaignMilestone.milestoneIdot4,
                  value: false)),
          remove('Hra',
              condition: MilestoneCondition(CampaignMilestone.milestoneIdot4,
        ...
        onMilestone: {
          '_victory': [
            codex('Let’s Move Big Guy', page: 8),
...
For the remainder of the campaign, Hra is a character ally to Rovers, and starts each encounter deployed with you. For now, only use Hra’s “Marl” side.'''),
        ...
        placements: const [
          ...
          PlacementDef(name: 'Ashemak', c: 2, r: 8),
          PlacementDef(name: 'Ashemak', c: 11, r: 5),
          PlacementDef(name: 'Dekaha', c: 8, r: 1),
          PlacementDef(name: 'Dekaha', c: 6, r: 8),
          PlacementDef(name: 'Dekaha', c: 8, r: 4, minPlayers: 3),
...
For the remainder of the campaign, Hra is a character ally to Rovers, and starts each encounter deployed with you. For now, only use Hra’s “Marl” side.'''),
  ...
  static EncounterDef get encounter10dot5 => EncounterDef(
      ...
      onMilestone: {
        '_victory': [
          codex('Until It is Done', page: 10),
...
[*In the app, you can record which trait you have chosen from each Rover's menu.*]''')
      ...
      adversaries: [
        ...
        EncounterFigureDef(
          ...
          healthFormula: '15*R',
          traits: [
            '[Reaction] After an enemy within [Range] 1 attacks: ||| [m_attack] | [Range] 1 [DMG]2 | [Target] the enemy that attacked'
          ],
          affinities: {
            Ether.fire: 1,
            Ether.dim: 2,
        ...
        EncounterFigureDef(
          ...
          large: true,
          traits: [
            '[Reaction] After this unit suffers [DMG] from any source: ||| [POS] | [Range] 0 [DEF] 1'
          ],
          affinities: {
            Ether.earth: 1,
            Ether.wind: 1,
...
Spawn the Head using a normal one hex base within [Range] 1 of the Hastadilling. The Hastadilling now uses the Hastadilling Headless statistic block, recovering its current [HP] to maximum. Move the Hastadilling ability token to the same ability number on the Hastadilling Headless.'''),
        ...
        EncounterFigureDef(
          ...
          onSlain: [
            codex('Separate But Whole', page: 9),
...
When an adversary **with the [Infected] trait** is slain, place it off to the side of the map on its side. During the **start phase**, for each adversary that is both off to the side and flipped vertically, roll an ether dice from the general pool, then spawn that adversary at the space with the ether icon corresponding to the result of the roll. Then, for each adversary that is both off to the side and placed on its side, flip them vertically.'''),
        ...
        onMilestone: {
          ...
          '_victory': [
            codex('I Hope This Was Worth It', page: 10),
            victory(
                body:
        ...
        adversaries: [
          EncounterFigureDef(
            ...
            traits: [
              'Ignores the effects of water and xulc terrain.',
              '[React] After this unit is attacked within [Range] 1, it performs: ||| [m_attack] | [Range] 1 [DMG]2 '
            ],
            affinities: {
              Ether.dim: 1,
            },
          ...
          EncounterFigureDef(
            ...
            traits: [
              'Ignores the effects of water and xulc terrain.',
              '[React] After this unit is attacked at [Range] 2 or greater, it performs: ||| [POS] | [Range] 0 [DEF] 1'
            ],
            affinities: {
              Ether.dim: 2,
            },
          ...
          EncounterFigureDef(
            ...
            flies: true,
            traits: [
              '[Reaction] After this unit is attacked: ||| Logic: Retreat ||| [Dash] 3',
            ],
            affinities: {
              Ether.dim: 1,
            },
        ...
        placements: const [
          PlacementDef(name: 'Ashemak', c: 3, r: 1),
          PlacementDef(name: 'Ashemak', c: 5, r: 0, minPlayers: 4),
          PlacementDef(name: 'Ashemak', c: 9, r: 0),
          PlacementDef(name: 'Ashemak', c: 7, r: 7, minPlayers: 3),
          PlacementDef(name: 'Ashemak', c: 4, r: 6, minPlayers: 3),
...
When an adversary **with the [Infected] trait** is slain, place it off to the side of the map on its side. During the **start phase**, for each adversary that is both off to the side and flipped vertically, roll an ether dice from the general pool, then spawn that adversary at the space with the ether icon corresponding to the result of the roll. Then, for each adversary that is both off to the side and placed on its side, flip them vertically.'''),
        ...
        placements: const [
          ...
          PlacementDef(name: 'Gruv', c: 6, r: 3),
          PlacementDef(name: 'Hoard', type: PlacementType.object, c: 0, r: 0),
          PlacementDef(name: 'Hoard', type: PlacementType.object, c: 1, r: 0),
          PlacementDef(name: 'Hoard', type: PlacementType.object, c: 12, r: 0),
          PlacementDef(name: 'Hoard', type: PlacementType.object, c: 12, r: 1),
...
[*In the app, you can choose to resign your [HP] increase from each Rover's menu.*]'''),
        ...
        placements: const [
          PlacementDef(name: 'Dekaha', c: 0, r: 4),
          PlacementDef(name: 'Dekaha', c: 3, r: 10, minPlayers: 3),
          PlacementDef(name: 'Dekaha', c: 12, r: 6),
          PlacementDef(name: 'Dekaha', c: 9, r: 0, minPlayers: 4),
...
When an adversary with the **Infected** trait is slain, place it off to the side of the map on its side. During the **Start Phase**, for each adversary that is both off to the side and flipped vertically, roll an ether dice from the general pool, then spawn that adversary at the space with the ether icon corresponding to the result of the roll. Then, for each adversary that is both off to the side and placed on its side, flip them vertically.'''),
      ...
      onMilestone: {
        '_victory': [
          codex('No Sky Could Blind You Now', page: 12),
          victory(
              body:
                  '''The ritual was a success. The xulc parasites were expelled from those of the Urshif that were resisting the infection. The parasite within you is scared and asserting its dominance.
...
[*In the app, you can choose to resign your [HP] increase from each Rover's menu.*]'''),
      ...
      placements: const [
        ...
        PlacementDef(name: 'Hunter', c: 9, r: 10, minPlayers: 3),
        PlacementDef(name: 'Hunter', c: 12, r: 3, minPlayers: 4),
        PlacementDef(name: 'Terranape', c: 11, r: 1),
        PlacementDef(name: 'Nahadir', c: 5, r: 5),
        PlacementDef(name: 'Nahadir', c: 7, r: 5),
        PlacementDef(name: 'Nahadir', c: 6, r: 6),
        PlacementDef(
...
[*In the app, add the corresponding token to Hra to record your progress against this requirement.*]'''),
        ...
        onMilestone: {
          '_victory': [
            codex('Apocalypse Conduit', page: 14),
            victory(
                body:
                    'For the remainder of the campaign, during encounters use Hra’s “**Ether-Charged**” side.'),
          ]
        ...
        placements: const [
          ...
          PlacementDef(name: 'Hunter', c: 5, r: 10, minPlayers: 4),
          PlacementDef(name: 'Hunter', c: 7, r: 10, minPlayers: 3),
          PlacementDef(name: 'Crown', c: 6, r: 5),
          PlacementDef(
              name: 'Magic',
              type: PlacementType.trap,
              c: 4,
  ...
  static EncounterDef get encounter10dot9 => EncounterDef(
        ...
        challenges: [
          'All [mini-boss] units gain +R*3 [HP].',
          'Units that trigger a pod trap suffer [DMG]3. When a pod trap is triggered, roll the xulc dice and spawn the result in the space the trap was in.',
          '[DIM] Node:  Units that generate an ether dice while within [Range] 1 of this node generate a [dim] dice instead. Rovers can not take this dice.',
        ],
        onLoad: [
...
Remove Hra’s ally card from the game.'''),
        ...
        placementGroups: [
          PlacementGroupDef(
            name: 'Phase 2',
            placements: [
              PlacementDef(name: 'Gruv', c: 5, r: 5),
              PlacementDef(name: 'Terranape', c: 6, r: 4),
              PlacementDef(name: 'Crown', c: 7, r: 5),
            ],
          ),
  ...
  static EncounterDef get encounter10dot10 => EncounterDef(
        ...
        onMilestone: {
          '_phase2': [
            ...
            removeRule('Phase 1'),
            codex('Everything Executioner', page: 16),
            placementGroup('Phase 2', silent: true),
...
They have two rows of 4 abilities, for a total of 8 abilities. These still act like one track. When the ability token advances beyond the 4th ability, place the token on the 5th ability and continue advancing the token along the track. When the token would advance beyond ability 8, it wraps around back to ability 1.'''),
          ...
          '_phase3': [
            ...
            removeRule('Phase 2'),
            codex('If It Bleeds, We Can Kill It', page: 16),
...
You have won! The campaign is now over.'''),
        ...
        adversaries: [
          ...
          EncounterFigureDef(
            ...
            onDraw: {
              EtherDieSide.air.toJson(): [
                addToken(EtherDieSide.air.toJson()),
              ],
              EtherDieSide.crux.toJson(): [
