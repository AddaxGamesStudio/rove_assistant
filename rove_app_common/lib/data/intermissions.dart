...
extension Intermissions on EncounterDef {
  static EncounterDef get encounterIdot1 => EncounterDef(
        questId: 'I',
        number: '1',
...
The adversaries within this encounter are native to the Zydero Reefs and ignore the effects of **Ferrorsands**.'''),
  ...
  static EncounterDef get encounterIdot2 => EncounterDef(
        questId: 'I',
        number: '2',
...
All enemies within [Range] 1-2 suffer [DMG]1.''',
  ...
  static EncounterDef get encounterIdot3 => EncounterDef(
      questId: 'I',
      number: '3',
      ...
      dialogs: [
        EncounterDialogDef(
            title: 'Introduction', body: '''*Notes from Tuor’s bestiary*
...
Place a [windscreen] on the Kaleido's statistic block. *[The app does this automatically.]*'''),
  ...
  static EncounterDef get encounterIdot4 => EncounterDef(
        questId: 'I',
        number: '4',
...
Hra follows all the adversary logic rules found on page X in the rule book. During their turn, Hra performs the following ability:

[Dash] 1 << Ignore all movement penalties. || [m_attack] | [Range] 1 [DMG]3 | Push] 3 |'''),
        ],
        onMilestone: {
          '_victory': [
            codex('Hey There Big Guy'),
            victory(),
          ]
        },
        startingMap: MapDef(
