  ...
  static EncounterDef get encounter7dot1 => EncounterDef(
        ...
        adversaries: [
          ...
          EncounterFigureDef(
            ...
            flies: true,
            traits: [
              '[React] Before this unit is slain, it performs: [m_attack] | [Range] 1-2 [DMG]2 | [miasma] | [Target] all units',
            ],
            affinities: {
              Ether.morph: 2,
              Ether.crux: -2,
          ...
          EncounterFigureDef(
            ...
            health: 16,
            traits: [
              '[React] When this unit is slain: Spawn one Broken Vessel in the space this unit occupied.',
            ],
            affinities: {
              Ether.morph: 2,
              Ether.crux: -2,
...
When an adversary is slain, place it off to the side of the map. During the start phase of rounds 2, 4, and 6, for each adversary that is to the side of the map, roll an ether dice from the general pool, then spawn that adversary at the space with the ether icon corresponding to the result that was just rolled.'''),
          rules('Ozendyn',
              'Ozendyn is a character ally to Rovers. For this encounter Ozendyn will only use the “Picket” side and will not flip.'),
          rules('Balatronists',
              '''The querists are part of their own faction, The Balatronists, which are allies to Rovers and enemies to adversaries. Units a part of The Balatronists follow all the adversary logic rules on page X in the rule book. This faction gains priority after the Adversary faction has gone.'''),
        ],
        onDidStartRound: [
          EncounterAction(
        ...
        adversaries: [
          ...
          EncounterFigureDef(
            ...
            health: 10,
            traits: [
              '[React] After this unit suffers damage from any source and it is at 2 or less [HP]: They flee. Remove this unit from the map.',
            ],
            affinities: {
              Ether.crux: 2,
              Ether.wind: 1,
          ...
          PlacementGroupDef(
            ...
            placements: [
              PlacementDef(name: 'Scour', c: 11, r: 4, onSlain: [
                codex('Where Did That Come From?'),
                item('Scour Brand'),
              ]),
            ],
          ),
  ...
  static EncounterDef get encounter7dot3 => EncounterDef(
        ...
        onLoad: [
          ...
          rules('Ozendyn',
              '''Ozendyn is a character ally to Rovers. For this encounter Ozendyn will only use the “Picket” side and will not flip.'''),
          rules('Star Hunters',
              '''Harrows, wrathbone, and dyads are part of their own faction, Star Hunters, which are enemies to Rovers and adversaries alike. Units a part of Star Hunters follow all the adversary logic rules on page X in the rule book. This faction gains priority after the adversary faction has gone.
...
[Dash] 2 || [m_attack] | [Range] 1 [DMG]3

The Borrowed Vessel performs:
[Dash] 3 || [r_attack] | [Range] 2-3 [DMG]3 | >> Logic: Retreat. ||| [Dash] 3''',
          ),
        ],
        onLoad: [
          rules('Countdown to Doom',
...
[Dash] 3 || [r_attack] | [Range] 2-3 [DMG]3 | >> Logic: Retreat. ||| [Dash] 3'''),
        ...
        placements: [
          ...
          PlacementDef(name: 'Darkened Sky', c: 9, r: 3, onSlain: [
            codex('All Consuming Ether'),
            victory(),
          ]),
...
While Bazhar creates his macabre forms of living ether, they do not act like a traditional adversary and do not take turns during the adversary phase. At the start of the adversary phase, reference the encounter table, executing the effects based on the current round count. Slay Bazhar quickly before you are overwhelmed.
...
There are six ether icons placed throughout the map. These icons represent possible spawn locations throughout the encounter. When an adversary would be spawned, roll an ether dice to determine its spawn location.''')
        ...
        adversaries: [
          EncounterFigureDef(
            ...
            healthFormula: '16*R',
            defenseFormula: 'X',
            xDefinition: 'count_adversary(Broken Vessel)',
            large: true,
            immuneToForcedMovement: true,
            affinities: {
              Ether.morph: 9,
        ...
        placements: [
          PlacementDef(name: 'Bazhar Creator', c: 6, r: 5, onSlain: [
            codex('Bazhar Defeated'),
            victory(),
            codex('XXXX'),
          ]),
          PlacementDef(name: 'Stomaw', c: 6, r: 6),
          PlacementDef(name: 'Stomaw', c: 6, r: 1),
          PlacementDef(name: 'Stomaw', c: 10, r: 6),
          PlacementDef(
              name: 'Magic',
              type: PlacementType.trap,
              c: 3,
