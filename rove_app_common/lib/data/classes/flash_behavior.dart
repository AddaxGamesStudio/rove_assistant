...
class FlashBehavior extends RoverClassBehavior {
  ...
  List<AbilityDef> get abilities {
    return [
      ...
      AbilityDef(name: 'Channel', actions: [
        RoveAction.infuseEther(),
        RoveAction.generateEther(),
      ]),
      AbilityDef(name: 'Gale', actions: [
  ...
  List<SkillDef> get skills {
    return [
      ...
      SkillDef(
          ...
          back: 'Suffuse',
          actions: [
            RoveAction.createTrap(3, endRange: 3),
          ],
          etherCost: 1),
      SkillDef(
          id: 'S-055',
                ...
                .withAugment(ActionAugment(
                    ...
                    action: RoveAction(
                        ...
                        staticDescription: RoveActionDescription(
                            body:
                                'The attack targeting the center hex gains +2 [DMG]')))),
      ...
      SkillDef(
          ...
          actions: [
            RoveAction(
                    ...
                    staticDescription: RoveActionDescription(
                        prefix:
                            'Select one space within [range] 1-4 to perform:',
                        suffix: 'Pull all targets toward the selected space.'))
      ...
      SkillDef(
          ...
          back: 'Zephyr',
          actions: [
            RoveAction.createTrap(2, endRange: 3),
            RoveAction.generateEther(ether: Ether.wind)
          ]),
      SkillDef(
          id: 'S-072',
          ...
          back: 'Mistral',
          actions: [
            RoveAction.buff(BuffType.trapDamage, 2),
            RoveAction.rangeAttack(4, endRange: 4, push: 2).withAugment(
                ActionAugment(
                    condition: EtherCheckCondition(
                        ethers: const [Ether.wind, Ether.wind]),
                    action: RoveAction.buff(BuffType.push, 2))),
    ...
    return [
      ReactionDef(
          ...
          trigger: ReactionTriggerDef(
              type: RoveEventType.afterAttack, targetKind: TargetKind.self),
          actions: [
      ...
      ReactionDef(
          ...
          actions: [
            RoveAction.generateEther(),
            RoveAction(
                type: RoveActionType.rerollEther, requiresPrevious: true),
          ]),
      ReactionDef(
          id: 'S-066',
          name: 'Stoke',
