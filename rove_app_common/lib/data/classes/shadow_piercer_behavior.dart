      ...
      SkillDef(
          ...
          actions: [
            ...
            RoveAction(
                ...
                range: (1, 1),
                requiresPrevious: true),
            RoveAction.flip(SubtypeFlipCondition(subtype: 'Eye'))
          ],
          etherCost: 2),
      SkillDef(
          id: 'S-113',
          ...
          actions: [
            RoveAction.generateEther().withAugment(ActionAugment(
                ...
                action: RoveAction(
                    ...
                    object:
                        Ether.etherOptionsToString([Ether.water, Ether.morph])),
                isReplacement: true))
          ]),
      ReactionDef(
          id: 'S-116',
