...
class SophistBehavior extends RoverClassBehavior {
  ...
  List<AbilityDef> get abilities {
    return [
      AbilityDef(name: 'Vault', actions: [
        RoveAction.jump(3),
      ]),
      AbilityDef(name: 'Beset', actions: [
        RoveAction.meleeAttack(1, endRange: 2),
      ]),
      AbilityDef(name: 'Inspire', actions: [
        RoveAction(
      ...
      AbilityDef(name: 'Manifest', actions: [
      ...
      SkillDef(
        ...
        actions: [
          RoveAction(
                  ...
                  amount: 3,
                  rangeOrigin: RoveActionRangeOrigin.actorOrGlyph,
                  range: (1, 2),
                  targetCount: 2,
                  staticDescription: RoveActionDescription(
                      prefix: 'Both you and one of your glyphs perform'))
      ...
      SkillDef(
          ...
          actions: [
            ...
            RoveAction(
                    ...
                    staticDescription: RoveActionDescription(
                        body:
                            'Force up to three enemies to perform [MOVE] 3 towards the selected glyph.\nThose enemies suffer [DMG]1.'))
                .withEtherCheckAugment(
                    ...
                    action: RoveAction(
                        ...
                        range: (0, 0),
                        staticDescription: RoveActionDescription(
                            body: 'Place one [ICE] where the glyph is.'))),
          ]),
      SkillDef(
          id: 'S-180',
    ...
    return [
      ReactionDef(
          ...
          trigger: ReactionTriggerDef(
              ...
              range: (0, 3),
              staticDescription:
                  'Before you or an ally within (1, 3) are attacked:'),
          actions: [
            RoveAction(
      ...
      ReactionDef(
          ...
          trigger: ReactionTriggerDef(
            ...
            range: (0, 1),
            staticDescription:
                'Before an enemy starts their turn within (0, 1) of one of your glyphs:',
          ),
          actions: [
            RoveAction(
                actor: RoveActionActorKind.eventTarget,
      ...
      ReactionDef(
          ...
          isUpgrade: true,
          trigger: ReactionTriggerDef(
              type: RoveEventType.beforeAttack, targetKind: TargetKind.self),
          actions: [
