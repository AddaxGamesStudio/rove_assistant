...
When an adversary is slain, place it off to the side of the map on its side. During the **Start Phase**, for each adversary that is both off to the side and flipped vertically, roll an ether dice from the general pool, then spawn that adversary at the space with the ether icon corresponding to the result that was just rolled. Then, for each adversary that is both off to the side and placed on its side, flip them vertically.'''),
        ...
        onMilestone: {
          '_victory': [
            codex('Unnatural Stillness', page: 14),
            victory(),
          ]
        },
        onWillEndRound: [
        ...
        adversaries: [
          ...
          EncounterFigureDef(
              ...
              onSlain: [
                ...
                codex('Creeping Darkness', page: 13),
  ...
  static EncounterDef get encounter1dot3 => EncounterDef(
      ...
      challenges: [
        'All skills that generate [ether_dice] generate [morph] instead.',
      ...
      onWillEndRound: [
        codex('Into the Tainted Air', page: 15, condition: RoundCondition(2)),
      ],
      onDidStartRound: [
...
Spawn R-1 galeapers in empty spaces within [Range] 1 of it.'''
        ...
        placements: [
          ...
          PlacementDef(name: 'Hokmala', c: 6, r: 8, onSlain: [
            codex('Midst of Black Waters', page: 16),
            victory(),
          ]),
          ...
          PlacementDef(
              ...
              r: 8,
              onSlain: [
                codex('Not-So-Sweet Nektar', page: 16),
                lyst('5*R'),
                item('Captured Anima',
                    body:
        ...
        placementGroups: const [
          PlacementGroupDef(name: 'Not-So-Sweet Nektar (Left)', placements: [
            PlacementDef(name: 'Nektari', c: 1, r: 8),
            PlacementDef(name: 'Nektari', c: 1, r: 8),
            PlacementDef(name: 'Nektari', c: 1, r: 8, minPlayers: 3),
            PlacementDef(name: 'Nektari', c: 1, r: 8, minPlayers: 4),
          ]),
          PlacementGroupDef(name: 'Not-So-Sweet Nektar (Right)', placements: [
            PlacementDef(name: 'Nektari', c: 12, r: 6),
            PlacementDef(name: 'Nektari', c: 12, r: 6),
            PlacementDef(name: 'Nektari', c: 12, r: 6, minPlayers: 3),
            PlacementDef(name: 'Nektari', c: 12, r: 6, minPlayers: 4),
          ])
        ],
      );
...
[+1 [DMG] || You suffer [DMG]1.]'''
              ...
              onSlain: [
                ...
                codex('Taste of Morphic Paradise', page: 17),
                rules('Black Grove',
...
Remove all [Morph] dice from all [Morph] nodes and place them on the Ahma Wretched statistic block.'''),
          ...
          EncounterFigureDef(
              ...
              onSlain: [
                codex('Compulsions', page: 18),
                victory(),
                codex('Nevermore', page: 18),
              ]),
          EncounterFigureDef(
