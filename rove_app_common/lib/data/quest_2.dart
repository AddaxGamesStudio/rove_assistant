...
extension Quest2 on EncounterDef {
  static EncounterDef get encounter2dot1 => EncounterDef(
        ...
        adversaries: [
          ...
          EncounterFigureDef(
              ...
              onSlain: [
                codex('The Bush is the Obstacle', page: 19),
              ]),
          EncounterFigureDef(
              name: 'Gruv (miniboss)',
              alias: 'Gruv',
              ...
              onSlain: [
                codex('Dust Endures no Restraint', page: 19),
                victory(),
              ])
        ],
      );
  ...
  static EncounterDef get encounter2dot2 => EncounterDef(
        ...
        onMilestone: {
          '_victory': [
            codex('The Crystal and its Story', page: 20),
            victory(),
          ]
        },
        startingMap: MapDef(
        ...
        overlays: [
          EncounterFigureDef(name: 'Hoard', onLoot: [
            codex('Crystalline Depression', page: 19),
            lyst('10'),
          ])
        ],
        adversaries: [
...
*[In the app you can indicate this by selecting the Ashemak seed pod pile and adding tokens to it.]*'''),
        ...
        onMilestone: {
          '_victory': [
            codex('Hot and Dreadful', page: 21),
            victory(),
          ]
        },
...
All enemies within [Range] 1 suffer [DMG]1.'''
              ...
              onSlain: [
                codex('It Must Catch Fire', page: 20),
              ]),
          EncounterFigureDef(
            name: 'Sek',
            letter: 'B',
            ...
            abilities: [
              ...
              AbilityDef(
                ...
                actions: [
                  ...
                  RoveAction.meleeAttack(0,
                      ...
                      push: 2,
                      targetCount: RoveAction.allTargets,
                      aoe: AOEDef.x4Cleave()), // TODO: Review Cleaving Blow aoe
              ...
              AbilityDef(name: 'Piercing Lunge', actions: [
                ...
                RoveAction.meleeAttack(0,
                    ...
                    pierce: true,
                    targetCount: RoveAction.allTargets,
                    aoe: AOEDef.x3Line()) // TODO: Review Piercing Lunge AOE
              ]),
            ],
          ),
        ],
        placements: [
          ...
          PlacementDef(name: 'Zisafi Principal', c: 6, r: 1, onSlain: [
            codex('Agreement is the Best Weapon', page: 20),
            addToken('Key',
                title: 'Reward',
                body:
...
**Note**: **Hurry up!** is an ability and requires an ability activation to use.'''),
        ...
        onMilestone: {
          '_double_cross': [
            codex('Truth Cannot Know Itself', page: 22),
            rules('Double Cross',
...
**Victory Condition**: The victory condition has changed!  Slay Kelo & Saras.'''),
            victoryCondition('Slay Kelo & Saras.'),
            EncounterAction(
                type: EncounterActionType.setLossCondition, value: ''),
...
All units within [Range] 1 suffer [DMG]2.'''
              ...
              onSlain: [
                codex('Ready to Release', page: 22),
              ]),
          EncounterFigureDef(
            name: 'Zisafi',
            letter: 'C',
          ...
          EncounterFigureDef(
              ...
              onSlain: [
                EncounterAction(
                    ...
                    title: 'Dust Endures no Restraint',
                    value: 'X'),
                EncounterAction(
          ...
          EncounterFigureDef(
              ...
              onSlain: [
                codex('Don’t Touch my Chains', page: 23),
                victory(),
              ]),
          EncounterFigureDef(
              name: 'Urn',
              ...
              onSlain: [
                codex('Absorption Without Assimilation', page: 22),
                lyst('5*R'),
                item('Arcana Pigment',
                    body:
...
All units within [Range] 1 suffer [DMG]2.'''
          ...
          EncounterFigureDef(
            ...
            onSlain: [
              codex('Communicate Something Incommunicable', page: 25),
              victory(),
              item('Ezmenite Plate'),
              milestone(CampaignMilestone.milestone2dot5Sovereign),
              codex('Still and Solitary', page: 27),
            ],
          ),
          EncounterFigureDef(
            name: 'Marii Advocate',
            ...
            onSlain: [
              codex('Explain Something Inexplicable', page: 26),
              victory(),
              item('Ezmenite Lance'),
