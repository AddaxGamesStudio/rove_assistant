...
extension Quest3 on EncounterDef {
  static EncounterDef get encounter3dot1 => EncounterDef(
        ...
        onLoad: [
          rules('Ozendyn',
              '''Ozendyn: Ozendyn is a character ally to Rovers. For this encounter Ozendyn will only use the “Picket” side and will not flip.'''),
...
Enemies: Dekaha''',
        ...
        overlays: [
          EncounterFigureDef(
            ...
            healthFormula: '12*R',
            onSlain: [
              codex('Free From the Flesh', page: 28),
              victory(),
            ],
          )
        ],
        adversaries: [
          EncounterFigureDef(
            ...
            onSlain: [
              codex('Between its Glistening Teeth', page: 27),
            ],
          ),
          EncounterFigureDef(
            name: 'Broken Vessel',
...
All units within [Range] 1 suffer [DMG]2.'''
          ...
          EncounterFigureDef(
            ...
            onSlain: [
              codex('Whose Art Sublimely Shines', page: 27),
...
[m_attack] | [Range] 1 | [DMG]2 | [miasma] | [Target] all units'''
            ...
            onSlain: [
              codex('A Strange Spirit Stalks', page: 28),
            ],
          ),
          EncounterFigureDef(
            name: 'Dyad',
          ...
          EncounterFigureDef(
            ...
            onSlain: [
              codex('Monstrous, Unnatural, Colossal', page: 29),
              victory(),
            ],
          ),
          EncounterFigureDef(
            ...
            onSlain: [
              codex('Capacity for Detachment', page: 28),
              lyst('5*R'),
              item('Arcana Pigment',
                  body:
  ...
  static EncounterDef get encounter3dot3 => EncounterDef(
        ...
        overlays: [
          EncounterFigureDef(name: 'Hoard', onLoot: [
            codex('Ornamental Fruits', page: 29),
            item('Scour Ichor',
                body:
        ...
        adversaries: [
          EncounterFigureDef(
            ...
            onSlain: [
              codex('Slithering Malice', page: 29),
            ],
          ),
          EncounterFigureDef(
            name: 'Azoth',
          ...
          EncounterFigureDef(
            ...
            onSlain: [
              codex('Crown of a Shocking Eikon', page: 30),
              victory(),
            ],
          ),
        ],
        placements: const [
          ...
          PlacementDef(name: 'Crown (miniboss)', c: 5, r: 8),
...
You are on the ground floor and must ascend a precarious series of stairs. Slay all enemies to clear the floor and proceed to the next floor.'''),
        ...
        onMilestone: {
          '_first_floor_complete': [
            codex('In The Dank Twilight I Climbed', page: 31),
...
Place Rovers in [start] spaces and spawn adversaries according to Rover count as shown on the map. Rover [HP], ally character [HP], ether dice, and infusion dice carry over. Glyphs and summons carry over and are placed within [Range] 1 of their owner.'''),
          ...
          '_arboretum_complete': [
            codex('Scattered Petals', page: 33),
            item('Condensed Will',
...
Place Rovers in [start] spaces and spawn adversaries according to Rover count as shown on the map. Rover [HP], ally character [HP], ether dice, and infusion dice carry over. Glyphs and summons carry over and are placed within [Range] 1 of their owner.'''),
          ...
          '_laboratory_complete': [
            codex('In the Walls of Henzya', page: 35),
            victory(),
            lyst('20*R'),
          ],
          '_vault': [
...
Place Rovers in [start] spaces and spawn adversaries according to Rover count as shown on the map. Rover [HP], ally character [HP], ether dice, and infusion dice carry over. Glyphs and summons carry over and are placed within [Range] 1 of their owner.'''),
            ...
            codex('Vault', page: 34),
            victoryCondition(
                'Complete three floors, getting to the top of the tower.\n\n**Floor Victory Condition**: All Rovers and Ozendyn must occupy an exit space. Try to collect as many hoard tiles as you can before you leave.'),
            subtitle('Third Floor: Vault'),
            placementGroup('Vault', silent: true),
            terrain('Hoard tiles',
                'Hoard tiles in space [A] and [B] are special. Try your best to collect them.'),
...
Spawn one Broken Vessel in the space this unit occupied.'''
            ...
            onSlain: [
              codex('Combined to Inculcate', page: 31),
            ],
            reactions: [
              EnemyReactionDef(
                  trigger: ReactionTriggerDef(
...
[m_attack] | [Range] 1 | [DMG]2 | [miasma] | [Target] all units'''
            ...
            placements: [
              ...
              PlacementDef(
                ...
                r: 5,
                onSlain: [
                  codex('The Poison Spreads Far', page: 34),
                  item('Zaghan\'s Limb',
...
Remove that hoard tile and this unit from the map.'''
            ...
            placements: [
              ...
              PlacementDef(
                ...
                r: 10,
                onLoot: [
                  codex('Forgotten Treasure [A]', page: 35),
                  item('Miasma Cape',
              ...
              PlacementDef(
                ...
                r: 1,
                onLoot: [
                  codex('Forgotten Treasure [B]', page: 35),
              ...
              PlacementDef(
                ...
                r: 5,
                onLoot: [
                  codex('Forgotten Treasure', page: 35),
...
Spawn one Broken Vessel in the space this unit occupied.'''
        ...
        EncounterFigureDef(
          ...
          onSlain: [
            codex('Many Pairs of Legs', page: 36),
            rules(
                'Bazhar Charger',
...
Spawn one stomaw adjacent to each Rover.''',
        ...
        EncounterFigureDef(
          ...
          onSlain: [
            ...
            codex('Whisperer in the Darkness', page: 36),
            rules(
              'Bazhar Absolute',
...
Return Bazhar to its starting location. If there are other units occupying Bazhar’s starting location, move those units the fewest number of spaces so that they no longer occupy Bazhar’s starting location.'''),
        ...
        EncounterFigureDef(
          ...
          onSlain: [
            codex('One Black Tower', page: 37),
            victory(),
            codex('Creatures in the Walls', page: 37),
          ],
        ),
        EncounterFigureDef(
          name: 'Broken Vessel',
