...
const Map<String, String> _tagAssets = {
  ...
  'wildfire': 'assets/images/field_wildfire.webp',
  'snapfrost': 'assets/images/field_snapfrost.webp',
  'everbloom': 'assets/images/field_everbloom.webp',
  'windscreen': 'assets/images/field_windscreen.webp',
  'aura': 'assets/images/field_aura.webp',
  'miasma': 'assets/images/field_miasma.webp',
  'armor': 'assets/images/icon_armored_xulc.png',
  'cleaving': 'assets/images/icon_cleaving_xulc.png',
  'flying_xulc': 'assets/images/icon_flying_xulc.png',
...
String _assetForTag(tag) {
  ...
  if (EtherDieSide.values
      ...
      .map((e) => e.toLowerCase())
      .contains(tag)) {
    return 'assets/images/ether_$tag.png';
  }
...
class RoveText extends StatelessWidget {
  ...
  factory RoveText.label(String data,
    ...
    return RoveText(
      ...
      key: key,
      style: TextStyle(
          fontFamily: 'Cinder', fontSize: 20, color: color, height: 1),
      textAlign: textAlign,
      iconShadows: false,
    );
  }
  ...
  const RoveText(this.data,
      {super.key, this.style, this.textAlign, this.iconShadows = false});
  @override
...
class RoveTextHelper {
  static List<String> componentize(String text) {
    String tags = roveRepleceableTags
